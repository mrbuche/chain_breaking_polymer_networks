...
single_chain_model = Morse_FJC(N_b = 1, N_b_H = 32, kappa = 200, kappa_H = 500, \
	beta_u_b = 100, k_0 = 1e-2, varsigma = 1, beta_Delta_Psi_0 = 5)

# Plot the single-chain model
output_directory = '32_'
...
deformation_object = deform_network(F, 'uniaxial', total_time_in_seconds, single_chain_model, nondimensional_timestep_suggestion = 1e-1)#, num_grid_suggestion = 1025)
