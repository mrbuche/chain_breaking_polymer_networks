...
single_chain_model = ideal(k_0 = 0.37)

# Plot the single-chain model
output_directory = 'output_Long_transient/'
...
fraction = 0.16
F = results[1]
sigma_1 = n_over_beta*(1 - fraction)*results[5]
sigma_2 = n_over_beta*fraction*(F**2 - 1/F)
sigma_tot = sigma_1 + sigma_2
F_stress_2 = F, sigma_2
F_stress_tot = F, sigma_tot
...
plotter_object.plot_results(deformation_object, results, n_over_beta = n_over_beta, use_nominal = True, \
	data_F_stress = data_F_stress, F_stress_1 = F_stress_tot, F_stress_2 = F_stress_2)